      ...
      <div class="auth-wrapper">
        <div class="card auth-card">
          <div class="auth-header">
            ...
            <h1 id="auth-title" class="font-accent text-3xl font-normal mb-2">{dict.resetHeading}</h1>
            <p id="auth-subtitle" class="text-secondary m-0">{dict.resetSubtitle}</p>
          </div>

          <form id="reset-form" class="flex flex-col gap-5">
            <div>
              <label class="form-label">{dict.resetLabelNewPassword}</label>
              <input id="password" type="password" placeholder={dict.resetPlaceholderPassword} class="input" required />
            </div>

            <button id="submit-btn" type="submit" class="btn btn-primary">{dict.resetBtnUpdate}</button>
