          ...
          <nav class="site-nav">
            {user ? (
              <>
                ...
                <button id="sign-out" class="text-sm btn btn-secondary" style="padding:0.4rem 0.9rem;">{dict.homeNavSignOut}</button>
              ...
              <a href="/login" class="btn btn-primary" style="font-size:1rem; padding:0.6rem 1.5rem;">{dict.homeNavSignIn}</a>
            )}
          </nav>
        </header>
          ...
          <section class="site-main--narrow" style="padding-top:0; padding-bottom:4rem; text-align:center;">
            <div class="card card-body-lg" style="max-width:640px; margin:0 auto; box-shadow:var(--shadow-lg); position:relative;">
              ...
              <div class="form-group" style="text-align:left;">
                <label for="topic" class="form-label" style="font-size:1rem; color:var(--text-primary); margin-bottom:0.5rem;">{dict.homeFormLabelTopic}</label>
                <input
                  id="topic"
                  type="text"
                  placeholder={dict.homeFormPlaceholderTopic}
                  class="input"
                  required
                />
              </div>
              ...
              <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1.5rem; text-align:left;">
                <div>
                  <label for="curriculum" class="form-label" style="font-size:0.9rem;">{dict.homeFormLabelCurriculum}</label>
                ...
                <div>
                  <label for="yearLevel" class="form-label" style="font-size:0.9rem;">{dict.homeFormLabelYearLevel}</label>
              ...
              <div id="status-container" class="hidden animate-fade-in" style="margin-top:1rem;">
                <div class="status-box" style="border-radius:1rem;">
                  ...
                  <div style="text-align:left;">
                    <p id="status-text" style="font-size:1rem; font-weight:600; margin:0; color:var(--text-primary);">{dict.homeStatusGenerating}</p>
                    <p class="text-xs" style="margin:0.25rem 0 0; color:var(--text-secondary);">{dict.homeStatusTime}</p>
                  </div>
                </div>
              </div>
          ...
          <section style="padding:5rem 1.5rem; text-align:center; position:relative;">
            <div style="max-width:var(--max-width); margin:0 auto;">
              ...
              <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:2rem; max-width:1000px; margin:0 auto;">
                {[
                  { num: dict.homeStep1Num, title: dict.homeStep1Title, desc: dict.homeStep1Desc },
                  { num: dict.homeStep2Num, title: dict.homeStep2Title, desc: dict.homeStep2Desc },
                  { num: dict.homeStep3Num, title: dict.homeStep3Title, desc: dict.homeStep3Desc },
                ].map(step => (
          ...
          <section style="padding:6rem 1.5rem; text-align:center; background:rgba(255,255,255,0.4);">
            <div style="max-width:var(--max-width); margin:0 auto;">
              ...
              <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:2rem; max-width:1200px; margin:0 auto;">
                {[
                  { src: "/samples/ppt-screenshot.png", label: dict.homeSamplePPTLabel, ext: ".pptx", desc: dict.homeSamplePPTDesc },
                  { src: "/samples/worksheet-screenshot.png", label: dict.homeSampleWorksheetLabel, ext: ".docx", desc: dict.homeSampleWorksheetDesc },
                  { src: "/samples/answer-key-screenshot.png", label: dict.homeSampleAnswerKeyLabel, ext: ".docx", desc: dict.homeSampleAnswerKeyDesc },
                  { src: "/samples/image-sample.png", label: dict.homeSampleImagesLabel, ext: ".png", desc: dict.homeSampleImagesDesc },
                ].map(item => (
