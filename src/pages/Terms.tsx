      ...
      <div class="page-wrapper">
        ...
        <main class="site-main--narrow">
          <div class="card" style="padding:2.5rem;">
            <h1 style="font-family:var(--font-accent); font-size:2rem; margin-bottom:2rem; color:var(--text-primary); font-weight:400;">{dict.termsTitle}</h1>
            ...
            <div style="display:flex; flex-direction:column; gap:2rem;">
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection1Title}</h2>
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection2Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection3Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection4Title}</h2>
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection5Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection6Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection7Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection8Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection9Title}</h2>
                <p class="text-secondary" style="line-height:1.7;">
              ...
              <section>
                <h2 style="font-family:var(--font-accent); font-size:1.25rem; margin-bottom:0.75rem; font-weight:400;">{dict.termsSection10Title}</h2>
