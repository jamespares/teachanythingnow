...
export const Footer: FC<FooterProps> = ({ dict, showLegal = true }) => {
  return (
    <footer class="border-t-strong py-12 px-6 text-center">
      <div class="flex flex-col items-center gap-4">
        ...
        {showLegal && (
          <div class="flex items-center gap-4 text-sm text-muted">
            <a href="/terms" class="text-muted hover:text-accent transition-colors">{dict.homeFooterTermsLink}</a>
            <span>·</span>
            <a href="/privacy" class="text-muted hover:text-accent transition-colors">{dict.homeFooterPrivacyLink}</a>
          </div>
        )}
